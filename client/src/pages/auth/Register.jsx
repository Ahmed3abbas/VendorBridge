    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-[420px]">
        ...
        <div className="bg-surface border border-border-subtle rounded-lg p-8">
          <form onSubmit={handleSubmit(d => doRegister(d))} className="flex flex-col gap-4">
            ...
            <Button type="submit" loading={isPending} className="w-full justify-center mt-2">Create Account</Button>
          </form>
        </div>
